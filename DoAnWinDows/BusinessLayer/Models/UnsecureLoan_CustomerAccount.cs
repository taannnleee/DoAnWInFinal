...
{
    internal class UnsecureLoan_CustomerAccount
    {
        private int loanID;
        ...
        public UnsecureLoan_CustomerAccount(int loanID, int accountNumber, string customerName, string loanAmount, int loanPeriod, string loanPayable, string loanStatus, DateTime startLoan, DateTime endLoan)
        {
            this.loanID = loanID;
        ...
        public UnsecureLoan_CustomerAccount() { }
